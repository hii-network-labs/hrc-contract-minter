  ...
  return (
    <div className="card-gradient relative">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold gradient-text mb-2">Deploy HRC-20 Token</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-gray-800">Token Name *</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-gray-800">Token Symbol *</label>
            <input
              type="text"
              name="symbol"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-gray-800">Total Supply *</label>
            <input
              type="text"
              name="totalSupply"
          ...
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-gray-800">Decimals</label>
            <div className="input-field bg-gray-100 text-gray-600 cursor-not-allowed">18</div>
            <p className="text-xs text-gray-500">
              Decimal places are fixed at 18 (standard for most tokens)
            </p>
          </div>
        </div>

        <div className="space-y-4">
          <label className="block text-sm font-semibold text-gray-800">Token Type *</label>
